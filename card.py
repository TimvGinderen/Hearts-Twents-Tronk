...
class Card:
    ...
    def __init__(self, suit, num):
   	 ...
   	 assert num >= 7 and num <= 14  # Updated range for 7 through Ace
   	 self.suit = suit
   	 self.num = num
    ...
    def createFromCardIdx(cls, card_idx):
        ...
        return Card(cls.Suit(card_idx // cls.NUM_CARDS_PER_SUIT), 7 + (card_idx % (cls.NUM_CARDS_PER_SUIT)))